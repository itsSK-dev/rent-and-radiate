  ...
  public: {
    Tables: {
      ...
      deposit_refunds: {
        ...
        Relationships: [
          {
            foreignKeyName: "deposit_refunds_customer_profiles_fkey"
            columns: ["customer_id"]
            isOneToOne: false
      ...
      manual_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "manual_payments_user_profiles_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      ratings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ratings_rater_profiles_fkey"
            columns: ["rater_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      rentals: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rentals_customer_profiles_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
